...
ob_start();
	...
	$image_blocks = [
		...
		[
			...
			'events'	=> [
				'07/09/2019 @ Blues Alley in DC',
				'07/11/2019 @ Tin Pan in Richmond, VA',
				"07/25/2019 @ Arlene's Grocery in NYC",
				'07/26/2019 @ Fridays at Fort Totten (MD)',
				'09/09/2019 @ Falls Church, VA (Sings Nancy Wilson)',
			]
		],
		// playlist block
		[
